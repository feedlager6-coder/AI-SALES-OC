...
| **Waterfall** | Стратегия: пробуем провайдеров по очереди, берём первый успешный |
| **ICP Score** | 0–100 балл соответствия Ideal Customer Profile |
...
| **SDR** | Sales Development Representative — пользователь системы |
