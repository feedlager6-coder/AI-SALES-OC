...
**AI Sales OS** — универсальная операционная система для B2B-продаж. Превращает поиск клиентов, квалификацию лидов и закрытие сделок из ручного хаоса в автоматизированный конвейер, управляемый AI-агентами.

**Первый продукт**: Платформа продаёт SaaS-сервис оптимизации маршрутов транспорта — логистическим компаниям, дистрибьюторам, курьерским службам в РФ/СНГ.

**Долгосрочно**: Платформа, способная продавать любой B2B SaaS через настройку конфигурации, без изменения ядра.
...
### ЭТО ЕСТЬ ✅
- Платформа автоматизации B2B outbound-продаж
- AI-ориентированный конвейер: поиск → обогащение → персонализация → отправка → трекинг
...
- Инструмент усиления SDR, не замены
...
### Алексей — Head of Sales (основной покупатель)
- 30–40 лет, B2B SaaS стартап или растущая компания
- Управляет командой 1–5 SDR
- Боль: лиды ищутся вручную, письма шаблонные, нет видимости
- Цель в системе: запустить кампанию, видеть pipeline и конверсию

### Ирина — SDR / Sales Manager (основной пользователь)
- 22–30 лет, делает 50–100 активностей/день
- Боль: 60% времени на не-продажи (ресёрч, ввод данных)
- Цель: получить готовые задачи, не искать контакты самостоятельно

### Дмитрий — CEO/Founder (executive stakeholder)
- Видит дашборд, принимает решения по бюджету
- Боль: нет данных для принятия решений
- Цель: видеть ROI, pipeline, прогноз выручки

### AI-агент / разработчик (технический пользователь)
- Настраивает вертикали, расширяет систему
